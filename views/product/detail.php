    ...
    <div class="span12">
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption">
                    <i class="icon-reorder"></i>Chi tiết sản phẩm
                </div>
                <div class="tools">
            ...
            <?php if (!empty($products)) { ?>
                <div class="portlet-body form">
                    ...
                    <div class="row-fluid">
                        <div class="span6 ">
                            <div class="control-group ">
                                <label class="control-label" for="lastName">Giá bán</label>
                                <div class="controls">
        ...
        <?php if (!empty($import)) { ?>  
            <div class="portlet box light-grey">
                <div class="portlet-title">
                    <div class="caption"><i class="icon-globe"></i>Thông tin nhập hàng</div>
                    <div class="tools">
                    ...
                    <div id="content">
                        <table id="table_product"
                            ...
                            <thead class="flip-content">
                                <tr>
                                    <th class="hidden-480">Kích thước</th>
                                    <th class="hidden-480">Số lượng</th>
                                    <th class="">Giá nhập(VND)</th>
                                    <th class="">Ngày Nhập</th>
                                </tr>
                            </thead>
                            <?php foreach ($import as $key => $value) : ?>
                                <tbody>
                                    <tr>
                                        <td><?php echo $value["SizeName"]; ?></td>
                                        <td class="hidden-480"><?php echo $value["ImportQuantity"]; ?></td>
                                        <td class="hidden-480"><?php echo $value["ImportPrice"]; ?></td>
                                        <td ><?php echo $value["ImportDate"]; ?></td>
                                    </tr>
                                </tbody>
                            <?php endforeach;
                            ?>
