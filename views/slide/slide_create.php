	...
	<div class="span12">
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption">
					<i class="icon-reorder"></i>Tạo slide mới
				</div>
				<div class="tools">
					...
					<div class="row-fluid">
						<div class="span12 ">
							<div class="control-group">
								...
								<div class="controls">
									<input name="SlideTitle" type="text" class="m-wrap span12"
										placeholder="Tiêu đề">
...
<script type="text/javascript">
    ...
    function imageBrowse(fileUrl, data)
    {
        ...
        html += '<a href = "" data-link = "' + foder + '/' + file + '"  class = "cboxElement">';
