					...
					<div class="row-fluid">
						...
						<div class="span6 ">
							<div class="control-group">
								...
								<div class="controls">
                                                                    <input name="CusUser" type="text" value="<?php echo $customers['CusUser'];?>"class="m-wrap span12"
										placeholder="">
					...
					<div class="row-fluid">
						<div class="span12 ">
							<div class="control-group">
								...
								<div class="controls">
                                                                    <input name="CusAdd" value="<?php echo $customers['CusAdd']?>"type="text" class="m-wrap span12">
                                                                        <span class="help-block"></span>
								</div>
							</div>
						</div>
					...
					<div class="row-fluid">
						<div class="span6 ">
							<div class="control-group">
								...
								<div class="controls">
                                                                        <input name="CusName" value="<?php echo $customers['CusName']?>"type="text" class="m-wrap span12"
										placeholder="">
                                                                        <span class="help-block"></span>
						...
						<div class="span6 ">
							<div class="control-group">
								...
								<div class="controls">
                                                                        <input name="CusEmail" value="<?php echo $customers['CusEmail']?>" type="text" class="m-wrap span12">
                                                                        <span class="help-block"></span>
								</div>
							</div>
						</div>
						<!--/span-->
							...
							<div class="control-group">
								...
								<div class="controls">
									<input name="CusPhone" value="<?php echo $customers['CusPhone']?>" type="text" class="m-wrap span12">
                                                                        <span class="help-block"></span>
								</div>
							</div>
						</div>
